...
module.exports = {
	...
	"input-time-element": "try{" +
		...
		"}catch(ex){return true;}",
	"range-progress": "const testInput = document.createElement(\"input\");" +
		"testInput.type = \"range\";" +
		"testInput.style.display = \"none\";" +
		"document.body.appendChild(testInput);" +
		"const result = getComputedStyle(testInput, \"::-webkit-slider-runnable-track\").length > 0;" +
		"testInput.remove();" +
		"return result;",
	"image-decode-html": "return typeof HTMLImageElement.prototype.decode !== \"function\""
}
